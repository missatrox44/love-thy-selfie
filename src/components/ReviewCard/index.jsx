...
function ReviewCard({ date, review, picture, name }) {
  return (
    <div className='col-span-2'>
      <blockquote
        className="flex h-full flex-col justify-between bg-white p-6 shadow"
      >
        <div>
          <div className="mt-4">
        ...
        <footer className="mt-8 text-sm text-gray-500 flex">
          &mdash; {name} <img className='h-4 w-4 ml-1' src='https://upload.wikimedia.org/wikipedia/commons/1/10/Blue_Badge.png' />
        </footer>
