    ...
    <div id='about' className='flex flex-col md:mb-9'>
      ...
      <div className='flex justify-center'>
        <ul className='karla-700 text-left text-lg md:text-xl lg:text-4xl'>
          <li className="my-2 lg:my-10">&hearts; Choose from 12 scenery backgrounds</li>
          <li className="my-2 lg:my-10">&hearts; Filters</li>
          <li className="my-2 lg:my-10">&hearts; Custom Frames available</li>
          <li className="my-2 lg:my-10">&hearts; Tons of props</li>
        </ul>
      </div>
    </div>
  )
